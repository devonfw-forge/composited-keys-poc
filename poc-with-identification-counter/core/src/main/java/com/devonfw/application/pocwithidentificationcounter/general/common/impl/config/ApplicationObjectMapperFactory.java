package com.devonfw.application.pocwithidentificationcounter.general.common.impl.config;
...
/**
 * The MappingFactory class to resolve polymorphic conflicts within the poc-with-identification-counter application.
 */
