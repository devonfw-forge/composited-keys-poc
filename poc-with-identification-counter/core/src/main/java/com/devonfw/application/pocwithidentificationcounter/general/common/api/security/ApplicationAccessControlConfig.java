package com.devonfw.application.pocwithidentificationcounter.general.common.api.security;
...
public class ApplicationAccessControlConfig extends AccessControlConfig {
  ...
  public static final String APP_ID = "poc-with-identification-counter";
